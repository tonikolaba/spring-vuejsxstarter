<template>
  <div class="submitform">
    <div v-if="!submitted">
        ...
        <div class="form-group">
          <label for="age"><font-awesome-icon icon="ellipsis-v" /> Age</label>
          <input type="number" class="form-control" id="age" required v-model="customer.age" name="age">
        </div>

        <button v-on:click="saveCustomer" class="btn btn-success"> <font-awesome-icon icon="save" />
 ...
 Submit</button>
    ...
    <div v-else>
      ...
      <button class="btn btn-success" v-on:click="newCustomer"> <font-awesome-icon icon="save" />
 Add</button>
    </div>
  </div>
</template>
